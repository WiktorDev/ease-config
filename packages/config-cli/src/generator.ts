...
function resolveDistDir(projectRoot: string): string {
  const distDir = path.join(projectRoot, "node_modules", "@ease-lab", "config", "dist");
...
function generateDistIndexDts(
  ...
  const header = [
    `// AUTO-GENERATED by @ease-lab/config-cli — do not edit manually`,
